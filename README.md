...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-picante-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-picante-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `r-picante` available on your platform:
...
```
pixi search r-picante --channel conda-forge
```
